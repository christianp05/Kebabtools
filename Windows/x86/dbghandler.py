...
STATUS_WX86_BREAKPOINT_EXCEPTION = 0x4000001F 
...
def debugException(process, dbgevent):
    print("Break")
    if dbgevent.u.Exception.ExceptionRecord.ExceptionCode == STATUS_WX86_BREAKPOINT_EXCEPTION:
        count = 0
        for i in process.BreakPoints:
            ...
            count += 1
        return -1
    if dbgevent.u.Exception.ExceptionRecord.ExceptionCode == STATUS_WX86_SINGLE_STEP:
        return -1
